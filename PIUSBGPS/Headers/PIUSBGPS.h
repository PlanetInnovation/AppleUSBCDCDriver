 ...
 */		
	...
	/*PIUSBGPS.h - This file contains the class definition for the	*/
	/* USB Communication Device Class (CDC) driver			 	*/

class PIUSBGPS : public IOService
{
    OSDeclareDefaultStructors(PIUSBGPS);			// Constructor & Destructor stuff
