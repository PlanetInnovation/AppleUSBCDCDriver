 ...
 */
    ...
    /* PIUSBGPSACMControl.cpp - MacOSX implementation of			*/
...
#define DEBUG_NAME "PIUSBGPSACMControl"

#include "PIUSBGPSACM.h"
#include "PIUSBGPSACMControl.h"

#define MIN_BAUD (50 << 1)

    // Globals

//PIUSBGPSACMData		*gDataDriver = NULL;
...
OSDefineMetaClassAndStructors(PIUSBGPSACMControl, IOService);
...
PIUSBGPS *findCDCDriverAC(void *controlAddr, IOReturn *retCode)
{
    PIUSBGPSACMControl	*me = (PIUSBGPSACMControl *)controlAddr;
    ...
    if (!iterator)
    {
        XTRACE(me, 0, 0, "findCDCDriverAC - No PIUSBGPS driver found!");
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::commReadComplete
//
//		Inputs:		obj - me
//				rc - return code
...
void PIUSBGPSACMControl::commReadComplete(void *obj, void *param, IOReturn rc, UInt32 remaining)
{
    PIUSBGPSACMControl	*me = (PIUSBGPSACMControl*)obj;
    IOReturn			ior;
    UInt32			dLen;
    UInt16			*tState;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::merWriteComplete
//
//		Inputs:		obj - me
//				param - MER 
//				rc - return code
...
void PIUSBGPSACMControl::merWriteComplete(void *obj, void *param, IOReturn rc, UInt32 remaining)
{
    PIUSBGPSACMControl	*me = (PIUSBGPSACMControl *)obj;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::probe
//
...
IOService* PIUSBGPSACMControl::probe( IOService *provider, SInt32 *score )
{ 
    IOService   *res;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::start
//
//		Inputs:		provider - my provider
//
...
bool PIUSBGPSACMControl::start(IOService *provider)
{
	IOReturn	rtn;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::stop
//
//		Inputs:		provider - my provider
//
//		Outputs:	None
...
void PIUSBGPSACMControl::stop(IOService *provider)
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::configureACM
//
//		Inputs:		
//
...
bool PIUSBGPSACMControl::configureACM()
{
    UInt8	protocol;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::getFunctionalDescriptors
//
//		Inputs:		
//
...
bool PIUSBGPSACMControl::getFunctionalDescriptors()
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::dataAcquired
//
//		Inputs:		None
//
...
bool PIUSBGPSACMControl::dataAcquired()
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::dataReleased
//
//		Inputs:		None
//
//		Outputs:	None
...
void PIUSBGPSACMControl::dataReleased()
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::USBSendSetLineCoding
//
...
void PIUSBGPSACMControl::USBSendSetLineCoding(UInt32 BaudRate, UInt8 StopBits, UInt8 TX_Parity, UInt8 CharLength)
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::USBSendSetControlLineState
//
...
void PIUSBGPSACMControl::USBSendSetControlLineState(bool RTS, bool DTR)
{
    IOReturn		rc;
    IOUSBDevRequest	*MER;
    UInt16		CSBitmap = 0;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::USBSendBreak
//
...
void PIUSBGPSACMControl::USBSendBreak(bool sBreak)
{
    IOReturn		rc;
    IOUSBDevRequest	*MER;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::checkPipe
//
...
IOReturn PIUSBGPSACMControl::checkPipe(IOUSBPipe *thePipe, bool devReq)
{
    IOReturn 	rtn = kIOReturnSuccess;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::allocateResources
//
//		Inputs:		
//
...
bool PIUSBGPSACMControl::allocateResources()
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::releaseResources
//
//		Inputs:		
//
//		Outputs:	
...
void PIUSBGPSACMControl::releaseResources()
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::checkInterfaceNumber
//
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::resetDevice
//
//		Inputs:		
//
//		Outputs:	
...
void PIUSBGPSACMControl::resetDevice(void)
{
    IOReturn 	rtn = kIOReturnSuccess;
    USBStatus	status;
    bool	reset = false;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::message
//
...
IOReturn PIUSBGPSACMControl::message(UInt32 type, IOService *provider, void *argument)
{	
	IOReturn	rtn;
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::initForPM
//
//		Inputs:		provider - my provider
//
...
bool PIUSBGPSACMControl::initForPM(IOService *provider)
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::initialPowerStateForDomainState
//
//		Inputs:		flags - 
//
...
unsigned long PIUSBGPSACMControl::initialPowerStateForDomainState(IOPMPowerFlags flags)
{
...
/****************************************************************************************************/
//
//		Method:		PIUSBGPSACMControl::setPowerState
//
...
IOReturn PIUSBGPSACMControl::setPowerState(unsigned long powerStateOrdinal, IOService *whatDevice)
{
