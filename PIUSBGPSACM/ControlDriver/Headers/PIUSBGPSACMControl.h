...
class PIUSBGPSACMData;
	...
	/* PIUSBGPSACMControl.h - This file contains the class definition for the		*/
	/* USB Communication Device Class (CDC) ACM Control driver. 				*/

class PIUSBGPSACMControl : public IOService
{
    OSDeclareDefaultStructors(PIUSBGPSACMControl);			// Constructor & Destructor stuff

private:
	PIUSBGPS				*fCDCDriver;		// The CDC driver
    PIUSBGPSACMData		*fDataDriver;       // Our Data Driver
...
public:
    ...
    virtual bool		checkInterfaceNumber(PIUSBGPSACMData *dataDriver);
